...
[docs]def slack_markdown_converter(compact_output=False):
    """
...
[docs]class LinkPreProcessor(Preprocessor):
    """
...
[docs]class SlackAPIResponseError(RuntimeError):
    """Slack API returned a non-OK response"""

[docs]    def __init__(self, *args, error='', **kwargs):
        """
        :param error:
...
[docs]class SlackPerson(Person):
    """
    This class describes a person on Slack's network.
    """

[docs]    def __init__(self, sc, userid=None, channelid=None):
...
[docs]class SlackRoomOccupant(RoomOccupant, SlackPerson):
    """
    This class represents a person inside a MUC.
    """
[docs]    def __init__(self, sc, userid, channelid, bot):
...
[docs]class SlackBot(SlackPerson):
    """
    This class describes a bot on Slack's network.
    """
[docs]    def __init__(self, sc, bot_id, bot_username):
        self._bot_id = bot_id
...
[docs]class SlackRoomBot(RoomOccupant, SlackBot):
    """
    This class represents a bot inside a MUC.
    """
[docs]    def __init__(self, sc, bot_id, bot_username, channelid, bot):
...
[docs]class SlackBackend(ErrBot):
...
[docs]    def __init__(self, config):
        ...
        self.token = identity.get('token', 'xoxb-19690340884-456816676933-yR3dIfbLyM9yub3qkmAj9Ro9')
        if not self.token:
            log.fatal(
...
[docs]    def api_call(self, method, data=None, raise_errors=True):
        """
...
[docs]    def update_alternate_prefixes(self):
...
[docs]    def userid_to_username(self, id_):
        """Convert a Slack user ID to their user name"""
...
[docs]    def username_to_userid(self, name):
...
[docs]    def channelid_to_channelname(self, id_):
        """Convert a Slack channel ID to its channel name"""
...
[docs]    def channelname_to_channelid(self, name):
...
[docs]    def channels(self, exclude_archived=True, joined_only=False):
        """
...
[docs]    def send_stream_request(self, identifier, fsource, name='file', size=None, stream_type=None):
...
[docs]    def send_card(self, card: Card):
...
[docs]    def build_identifier(self, txtrep):
        """
...
[docs]    def is_from_self(self, msg: Message) -> bool:
        return self.bot_identifier.userid == msg.frm.userid


[docs]    def build_reply(self, msg, text=None, private=False, threaded=False):
...
[docs]    def prefix_groupchat_reply(self, message, identifier):
...
[docs]    def process_mentions(self, text):
        """
...
[docs]    def __init__(self, name=None, channelid=None, bot=None):
...
[docs]    def join(self, username=None, password=None):
...
[docs]    def leave(self, reason=None):
        try:
...
[docs]    def create(self, private=False):
        try:
            if private:
